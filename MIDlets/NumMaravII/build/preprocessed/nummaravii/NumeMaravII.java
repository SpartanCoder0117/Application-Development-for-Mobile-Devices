 ...
 * @author inkis
 */
public class NumeMaravII extends MIDlet implements CommandListener {
...
exitMIDlet();//GEN-LINE:|7-commandAction|2|19-postAction
                ...
                while(num != 1){
                    ...
                    stringItem1.setText(num2 + " es un numero maravilloso!!");              
                }                
//GEN-LINE:|7-commandAction|4|23-postAction
 // write post-action user code here
} else if (command == okCommand1) {//GEN-LINE:|7-commandAction|5|30-preAction
                // write pre-action user code here
                //Numero primo 
                int num, num2;
                String primo = " es numero primo";
                String noPrim = " no es numero primo";
                String cadena;
                ...
                cadena = (num2 == 1) ? primo : noPrim;
                stringItem.setText(num + cadena);      
                stringItem1.setText("");
//GEN-LINE:|7-commandAction|6|30-postAction
 // write post-action user code here
            ...
            numero = Integer.parseInt(textField.getString());
            while(fibo < numero){
                fibo = fibo + a;
                a = b;
                b = fibo;
            ...
            resultado = (fibo == numero || numero == 0) ? FB : NFB;
            stringItem.setText(resultado);
//GEN-LINE:|7-commandAction|8|32-postAction
 // write post-action user code here
} else if (command == okCommand3) {//GEN-LINE:|7-commandAction|9|34-preAction
 // write pre-action user code here
 //Palindromo
    String sPalabra = textField1.getString();
    int inc = 0;
...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("Practica 3", new Item[]{getTextField(), getTextField1(), getStringItem(), getStringItem1()});//GEN-BEGIN:|14-getter|1|14-postInit
            form.addCommand(getExitCommand());
            form.addCommand(getOkCommand());
            form.addCommand(getOkCommand1());
            form.addCommand(getOkCommand2());
            form.addCommand(getOkCommand3());
...
//GEN-END:|22-getter|0|22-preInit
 // write pre-init user code here
okCommand = new Command("Maravilloso", Command.OK, 0);//GEN-LINE:|22-getter|1|22-postInit
 // write post-init user code here
...
//GEN-END:|24-getter|0|24-preInit
 // write pre-init user code here
textField = new TextField("Ingresa un numero ", null, 32, TextField.ANY);//GEN-LINE:|24-getter|1|24-postInit
 // write post-init user code here
...
//GEN-END:|25-getter|0|25-preInit
 // write pre-init user code here
textField1 = new TextField("Ingresa una cadena", null, 32, TextField.ANY);//GEN-LINE:|25-getter|1|25-postInit
 // write post-init user code here
...
//GEN-END:|26-getter|0|26-preInit
 // write pre-init user code here
stringItem = new StringItem("stringItem", null);//GEN-LINE:|26-getter|1|26-postInit
 // write post-init user code here
...
//GEN-END:|27-getter|0|27-preInit
 // write pre-init user code here
stringItem1 = new StringItem("stringItem1", null);//GEN-LINE:|27-getter|1|27-postInit
 // write post-init user code here
...
//GEN-END:|29-getter|0|29-preInit
 // write pre-init user code here
okCommand1 = new Command("Primo", Command.OK, 0);//GEN-LINE:|29-getter|1|29-postInit
 // write post-init user code here
...
//GEN-END:|31-getter|0|31-preInit
 // write pre-init user code here
okCommand2 = new Command("Fibonacci", Command.OK, 0);//GEN-LINE:|31-getter|1|31-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: okCommand3 ">//GEN-BEGIN:|33-getter|0|33-preInit
    /**
...
//GEN-END:|33-getter|0|33-preInit
 // write pre-init user code here
okCommand3 = new Command("Palindromo", Command.OK, 0);//GEN-LINE:|33-getter|1|33-postInit
 // write post-init user code here
