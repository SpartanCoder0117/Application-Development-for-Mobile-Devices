...
exitMIDlet();//GEN-LINE:|7-commandAction|2|19-postAction
                ...
                while(num != 1){
                    if(num % 2 == 0){
                        ...
                        //46System.out.println(cadena);
                    }else{
                        num = num * 3 + 1;
                        cadena = cadena + num + "\n";
                        stringItem.setText(cadena);
                    }                        
                    stringItem1.setText("Es un numero maravilloso!!");              
                }                
...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("Numero Maravilloso", new Item[]{getTextField(), getStringItem(), getStringItem1()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//GEN-END:|22-getter|0|22-preInit
 // write pre-init user code here
okCommand = new Command("Ejecutar", Command.OK, 0);//GEN-LINE:|22-getter|1|22-postInit
 // write post-init user code here
...
//GEN-END:|25-getter|0|25-preInit
 // write pre-init user code here
stringItem = new StringItem("stringItem", null);//GEN-LINE:|25-getter|1|25-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem1 ">//GEN-BEGIN:|26-getter|0|26-preInit
    /**
    ...
    public StringItem getStringItem1() {
        if (stringItem1 == null) {//GEN-END:|26-getter|0|26-preInit
 // write pre-init user code here
stringItem1 = new StringItem("stringItem1", null);//GEN-LINE:|26-getter|1|26-postInit
 // write post-init user code here
