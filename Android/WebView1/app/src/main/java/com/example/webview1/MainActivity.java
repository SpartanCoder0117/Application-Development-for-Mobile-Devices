...
public class MainActivity extends Activity implements OnClickListener{
    ...
    EditText jet; String s="https://www.google.com/";
    ...
    public void onClick(View v){
        int id = v.getId();
        switch(id){
            case R.id.xbn1: wv.goBack();
            break;
            case R.id.xbn2: wv.loadUrl(s);
            break;
            case R.id.xbn3: wv.goForward();
            break;
            case R.id.xbn4: wv.loadUrl(jet.getText() + "");
            break;
        }
    }
}
